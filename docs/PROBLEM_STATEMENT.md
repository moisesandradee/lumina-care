# Problem Statement — Lumina

## The Mental Health Care Gap Is Structural, Not Incidental

The global mental health crisis is well-documented. What is less discussed is the **structural failure of the systems meant to address it** — and specifically, the information asymmetry that sits at the heart of that failure.

---

## Core Problem: Clinical Teams Are Flying Blind
...
- Care interaction logs
- Appointment histories
- Medication adherence records

But this information is **never synthesized, rarely surfaced proactively, and almost never available at the moment it matters most** — which is when a clinician must make a decision about a patient they haven't seen in two weeks.
...
- **Patients**: Receive care that is less timely, less personalized, and less continuous than it could be
- **Clinicians**: Carry cognitive and emotional load that technology could partially absorb, without replacing the human relationship
- **Care teams**: Operate without the intelligence infrastructure that would allow them to allocate attention effectively
- **Health systems**: Bear the downstream costs of late intervention, crisis-driven care, and high readmission rates

---

## Why Now

Three conditions have aligned to make this problem solvable at a level that wasn't previously possible:

1. **AI capability**: Large language models can now process clinical text with sufficient nuance to support — not replace — clinical reasoning
2. **Digital health infrastructure**: The proliferation of digital health interactions has created the data substrate that intelligence systems require
3. **Regulatory and ethical maturity**: The conversation about responsible AI in healthcare has matured enough to enable principled deployment

Lumina is positioned at the intersection of these three conditions.
